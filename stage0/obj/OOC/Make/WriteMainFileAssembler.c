...
l11:
  ...
  OOC_Make_WriteMainFileAssembler__WriteFile_Directive((OOC_CHAR8*)".text", 6);
  OOC_Make_WriteMainFileAssembler__WriteFile_Directive((OOC_CHAR8*)".Ltext0:", 9);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)".align 4", 9);
  OOC_Make_WriteMainFileAssembler__WriteFile_Directive((OOC_CHAR8*)".globl main", 12);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)".type \011 main,@function", 23);
  OOC_Make_WriteMainFileAssembler__WriteFile_Directive((OOC_CHAR8*)"main:", 6);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)"pushl %ebp", 11);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)"movl %esp,%ebp", 15);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)"subl $8,%esp", 13);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)"movl 8(%ebp),%eax", 18);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)"movl %eax,RT0__argc", 20);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)"movl 12(%ebp),%eax", 19);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)"movl %eax,RT0__argv", 20);
  i0 = (OOC_INT32)w;
  OOC_Make_WriteMainFileAssembler__WriteFile_WriteModules((IO_TextRider__Writer)i0, (OOC_CHAR8*)"\011call OOC_", 11, (OOC_CHAR8*)"_open", 6);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)"xorl %eax,%eax", 15);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)"leave", 6);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)"ret", 4);
  OOC_Make_WriteMainFileAssembler__WriteFile_Directive((OOC_CHAR8*)".Lfe1:", 7);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)".size\011 main,.Lfe1-main", 23);
  OOC_Make_WriteMainFileAssembler__WriteFile_Directive((OOC_CHAR8*)".Lscope0:", 10);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)".text", 6);
  OOC_Make_WriteMainFileAssembler__WriteFile_Directive((OOC_CHAR8*)"Letext:", 8);
  OOC_Make_WriteMainFileAssembler__WriteFile_Instr((OOC_CHAR8*)".ident\011\"OOC: 0.1\"", 18);
  i0 = (OOC_INT32)ch;
