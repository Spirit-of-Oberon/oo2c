...
l8:
  ...
  i1 = (OOC_INT32)sym;
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 2472))+8);
  i3 = *(OOC_INT32*)((_check_pointer(i1, 2482))+16);
  i4 = *(OOC_INT32*)((_check_pointer(i1, 2492))+20);
  i1 = *(OOC_INT32*)((_check_pointer(i1, 2503))+24);
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitModule(volatile OOC_AST_CreateSymTab__Visitor v, volatile OOC_AST__Module module) {
  ...
  i3 = *(OOC_INT32*)(_check_pointer(i1, 6509));
  i4 = *(OOC_INT32*)((_check_pointer(i1, 6546))+4);
  i5 = *(OOC_INT32*)((_check_pointer(i1, 6564))+8);
...
l26:
  i2=i5;i5=i7;i4=i6;
l28:
  i6 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i3, 7297));
  i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 7333))+4);
  i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 7339))+4);
  i3 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i3, 7297));
  i1 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i6, 7302)))), OOC_SymbolTable_Builder__BuilderDesc_NewModule)),OOC_SymbolTable_Builder__BuilderDesc_NewModule)((OOC_SymbolTable_Builder__Builder)i3, (OOC_SymbolTable__Name)i1, (OOC_Doc__Document)i7, i2, i4, (OOC_AST__Node)i0);
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitImportDecl(OOC_AST_CreateSymTab__Visitor v, OOC_AST__ImportDecl importDecl) {
  ...
  i3 = *(OOC_INT32*)(_check_pointer(i1, 11372));
  i4 = *(OOC_INT32*)((_check_pointer(i1, 11409))+4);
  i5 = *(OOC_INT32*)((_check_pointer(i1, 11427))+8);
  OOC_SymbolTable__InitName((OOC_SymbolTable__Name)i1, (OOC_Scanner_InputBuffer__CharArray)i2, i3, i4, i5);
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitConstDecl(OOC_AST_CreateSymTab__Visitor v, OOC_AST__ConstDecl constDecl) {
  ...
  i0 = (OOC_INT32)v;
  i1 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 12133));
  i2 = (OOC_INT32)constDecl;
  i3 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 12192));
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 12164))+4);
  i3 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i3, 12202));
  i0 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 12133));
  i3 = (OOC_INT32)OOC_AST_CreateSymTab__GetName((OOC_AST__Node)i3);
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 12229))+16);
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer((_type_guard(i5, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i5, 12245)))), &_td_OOC_AST__TerminalDesc, 12245)), 12254));
  i6 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 12295));
  i6 = OOC_AST_CreateSymTab__ExportMark((OOC_AST__Node)i6);
  i7 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 12317));
  i5 = *(OOC_INT32*)((_check_pointer(i5, 12259))+16);
  i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 12327))+8);
  i8 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 12367))+12);
  i0 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 12138)))), OOC_SymbolTable_Builder__BuilderDesc_NewConstDecl)),OOC_SymbolTable_Builder__BuilderDesc_NewConstDecl)((OOC_SymbolTable_Builder__Builder)i0, (OOC_SymbolTable__Item)i4, (OOC_SymbolTable__Name)i3, i5, i6, (OOC_Doc__Document)i7, (Object_Boxed__Object)0, (OOC_SymbolTable__PredefType)0, (OOC_AST__Node)i8);
  _const = (OOC_SymbolTable__ConstDecl)i0;
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 12393))+4);
  i1 = i1!=0;
  if (!i1) goto l4;
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 12443))+4);
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitTPSection(OOC_AST_CreateSymTab__Visitor v, OOC_AST__TPSection tpSection) {
  ...
  i4=0;
l3_loop:
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 12741));
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 12796))+4);
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i6, 12806))+4);
  i6 = _check_pointer(i6, 12808);
  i7 = OOC_ARRAY_LENGTH(i6, 0);
  i8 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 12770))+4);
  i6 = (OOC_INT32)*(OOC_INT32*)(i6+(_check_index(i4, i7, OOC_UINT32, 12808))*4);
  i7 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 12741));
  i6 = (OOC_INT32)OOC_AST_CreateSymTab__GetName((OOC_AST__Node)i6);
  i9 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 12844))+12);
  i9 = OOC_AST_CreateSymTab__EndOfType((OOC_AST__Node)i9);
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 12893))+4);
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i10, 12903))+4);
  i10 = _check_pointer(i10, 12905);
  i11 = OOC_ARRAY_LENGTH(i10, 0);
  i10 = (OOC_INT32)*(OOC_INT32*)(i10+(_check_index(i4, i11, OOC_UINT32, 12905))*4);
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i10, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i10, 12913)))), &_td_OOC_AST__IdentDefDesc, 12913)), 12922))+8);
  i5 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i5, 12745)))), OOC_SymbolTable_Builder__BuilderDesc_NewTypeDecl)),OOC_SymbolTable_Builder__BuilderDesc_NewTypeDecl)((OOC_SymbolTable_Builder__Builder)i7, (OOC_SymbolTable__Item)i8, (OOC_SymbolTable__Name)i6, i9, 0, (OOC_Doc__Document)i10, (OOC_SymbolTable__Type)i1, 1u);
...
l12:
  i3 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i1, 13574));
  i4 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 13628));
  i4 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i4, 13637));
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 13603))+4);
  i1 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i1, 13574));
  i4 = (OOC_INT32)OOC_AST_CreateSymTab__GetName((OOC_AST__Node)i4);
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 13673))+16);
  i6 = OOC_AST_CreateSymTab__EndOfType((OOC_AST__Node)i6);
  i7 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 13700));
  i7 = OOC_AST_CreateSymTab__ExportMark((OOC_AST__Node)i7);
  i8 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 13730));
  i8 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i8, 13739))+8);
  i1 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i3, 13579)))), OOC_SymbolTable_Builder__BuilderDesc_NewTypeDecl)),OOC_SymbolTable_Builder__BuilderDesc_NewTypeDecl)((OOC_SymbolTable_Builder__Builder)i1, (OOC_SymbolTable__Item)i5, (OOC_SymbolTable__Name)i4, i6, i7, (OOC_Doc__Document)i8, (OOC_SymbolTable__Type)i2, 0u);
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitVarDecl(OOC_AST_CreateSymTab__Visitor v, OOC_AST__VarDecl varDecl) {
  ...
  i4=0;
l3_loop:
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 14129));
  i6 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 14183));
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i6, 14194))+4);
  i6 = _check_pointer(i6, 14197);
  i7 = OOC_ARRAY_LENGTH(i6, 0);
  i6 = (OOC_INT32)*(OOC_INT32*)(i6+(_check_index(i4, i7, OOC_UINT32, 14197))*4);
  i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 14149))+4);
  i6 = (OOC_INT32)*(OOC_INT32*)(_check_pointer((_type_guard(i6, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i6, 14205)))), &_td_OOC_AST__IdentDefDesc, 14205)), 14214));
  i8 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 14129));
  i6 = (OOC_INT32)OOC_AST_CreateSymTab__GetName((OOC_AST__Node)i6);
  i9 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 14250))+8);
  i9 = OOC_AST_CreateSymTab__EndOfType((OOC_AST__Node)i9);
  i10 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 14286));
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i10, 14297))+4);
  i10 = _check_pointer(i10, 14300);
  i11 = OOC_ARRAY_LENGTH(i10, 0);
  i10 = (OOC_INT32)*(OOC_INT32*)(i10+(_check_index(i4, i11, OOC_UINT32, 14300))*4);
  i10 = OOC_AST_CreateSymTab__ExportMark((OOC_AST__Node)i10);
  i11 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 14322));
  i11 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i11, 14333))+4);
  i11 = _check_pointer(i11, 14336);
  i12 = OOC_ARRAY_LENGTH(i11, 0);
  i11 = (OOC_INT32)*(OOC_INT32*)(i11+(_check_index(i4, i12, OOC_UINT32, 14336))*4);
  i11 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i11, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i11, 14344)))), &_td_OOC_AST__IdentDefDesc, 14344)), 14353))+8);
  i5 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i5, 14134)))), OOC_SymbolTable_Builder__BuilderDesc_NewVarDecl)),OOC_SymbolTable_Builder__BuilderDesc_NewVarDecl)((OOC_SymbolTable_Builder__Builder)i8, (OOC_SymbolTable__Item)i7, (OOC_SymbolTable__Name)i6, i9, i10, (OOC_Doc__Document)i11, 0u, 0u, 0u, (OOC_SymbolTable__Type)i1);
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitReceiver(OOC_AST_CreateSymTab__Visitor v, OOC_AST__Receiver receiver) {
  ...
  i1 = (OOC_INT32)OOC_AST_CreateSymTab__GetType((OOC_AST_CreateSymTab__Visitor)i2, (OOC_AST__Node)i1);
  type = (OOC_SymbolTable__Type)i1;
  i3 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 14794));
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 14814))+4);
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 14848))+8);
  i6 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 14794));
  i5 = (OOC_INT32)OOC_AST_CreateSymTab__GetName((OOC_AST__Node)i5);
  i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 14877))+16);
  i7 = OOC_AST_CreateSymTab__EndOfType((OOC_AST__Node)i7);
  i8 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 14921))+8);
  i9 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 14967))+4);
  i8 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i8, 14928))+8);
  i1 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i3, 14799)))), OOC_SymbolTable_Builder__BuilderDesc_NewVarDecl)),OOC_SymbolTable_Builder__BuilderDesc_NewVarDecl)((OOC_SymbolTable_Builder__Builder)i6, (OOC_SymbolTable__Item)i4, (OOC_SymbolTable__Name)i5, i7, 0, (OOC_Doc__Document)i8, 1u, 1u, (i9!=0), (OOC_SymbolTable__Type)i1);
  ...
  *(OOC_UINT8*)((_check_pointer(i1, 15038))+58) = 1u;
  ...
  i3=0;
l5_loop:
  i4 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 15169));
  ...
  i5 = (OOC_INT32)OOC_AST_CreateSymTab__GetName((OOC_AST__Node)i5);
  i8 = _check_pointer(i1, 15243);
  i9 = OOC_ARRAY_LENGTH(i8, 0);
  i8 = (OOC_INT32)*(OOC_INT32*)(i8+(_check_index(i3, i9, OOC_UINT32, 15243))*4);
  i8 = OOC_AST_CreateSymTab__EndOfType((OOC_AST__Node)i8);
  i4 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i4, 15173)))), OOC_SymbolTable_Builder__BuilderDesc_NewTypeDecl)),OOC_SymbolTable_Builder__BuilderDesc_NewTypeDecl)((OOC_SymbolTable_Builder__Builder)i6, (OOC_SymbolTable__Item)i7, (OOC_SymbolTable__Name)i5, i8, 0, (OOC_Doc__Document)0, (OOC_SymbolTable__Type)0, 0u);
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitFPSection(OOC_AST_CreateSymTab__Visitor v, OOC_AST__FPSection fpSection) {
  ...
  i4=0;
l3_loop:
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 15613));
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 15669))+4);
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i6, 15680))+4);
  i6 = _check_pointer(i6, 15683);
  i7 = OOC_ARRAY_LENGTH(i6, 0);
  i8 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 15633))+4);
  i6 = (OOC_INT32)*(OOC_INT32*)(i6+(_check_index(i4, i7, OOC_UINT32, 15683))*4);
  i7 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 15613));
  i6 = (OOC_INT32)OOC_AST_CreateSymTab__GetName((OOC_AST__Node)i6);
  i9 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 15717))+12);
  i9 = OOC_AST_CreateSymTab__EndOfType((OOC_AST__Node)i9);
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 15764))+4);
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i10, 15775))+4);
  i10 = _check_pointer(i10, 15778);
  i11 = OOC_ARRAY_LENGTH(i10, 0);
  i10 = (OOC_INT32)*(OOC_INT32*)(i10+(_check_index(i4, i11, OOC_UINT32, 15778))*4);
  i11 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 15838));
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i10, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i10, 15786)))), &_td_OOC_AST__IdentDefDesc, 15786)), 15795))+8);
  i5 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i5, 15618)))), OOC_SymbolTable_Builder__BuilderDesc_NewVarDecl)),OOC_SymbolTable_Builder__BuilderDesc_NewVarDecl)((OOC_SymbolTable_Builder__Builder)i7, (OOC_SymbolTable__Item)i8, (OOC_SymbolTable__Name)i6, i9, 0, (OOC_Doc__Document)i10, 1u, 0u, (i11!=0), (OOC_SymbolTable__Type)i1);
  var = (OOC_SymbolTable__VarDecl)i5;
...
l4:
  ...
  i3 = OOC_ARRAY_LENGTH((_check_pointer(i3, 17560)), 0);
  i2 = OOC_SymbolTable_Predef__IsStaticMethod((void*)(_check_pointer(i2, 17560)), i3);
  if (i2) goto l9;
  procClass = 1;
  i2=1;
  goto l12;
...
l12:
  i3 = (OOC_INT32)v;
  i4 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i3, 17674));
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 17729))+16);
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 17695))+4);
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i5, 17739));
  i7 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i3, 17674));
  i5 = (OOC_INT32)OOC_AST_CreateSymTab__GetName((OOC_AST__Node)i5);
  i8 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 17783))+16);
  i8 = OOC_AST_CreateSymTab__ExportMark((OOC_AST__Node)i8);
  i9 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 17810))+16);
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 17858))+4);
  i9 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i9, 17820))+8);
  i1 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i4, 17679)))), OOC_SymbolTable_Builder__BuilderDesc_NewProcDecl)),OOC_SymbolTable_Builder__BuilderDesc_NewProcDecl)((OOC_SymbolTable_Builder__Builder)i7, (OOC_SymbolTable__Item)i6, (OOC_SymbolTable__Name)i5, i1, i8, (OOC_Doc__Document)i9, i2, (i10!=0), (OOC_AST__Node)i0);
  proc = (OOC_SymbolTable__ProcDecl)i1;
  i2 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i3, 17908));
  i4 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 17998));
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i3, 17908));
  i4 = (OOC_INT32)OOC_AST_CreateSymTab__GetPosition((OOC_AST__Node)i4);
  i2 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 17913)))), OOC_SymbolTable_Builder__BuilderDesc_NewFormalPars)),OOC_SymbolTable_Builder__BuilderDesc_NewFormalPars)((OOC_SymbolTable_Builder__Builder)i5, (OOC_SymbolTable__Item)i1, (OOC_SymbolTable__Position)i4);
  formalPars = (OOC_SymbolTable__FormalPars)i2;
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 18024))+20);
  i4 = i4!=0;
  if (i4) goto l15;
  i4=0u;
  goto l17;
l15:
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 18062))+20);
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i4, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i4, 18079)))), &_td_OOC_AST__FormalParsDesc, 18079)), 18090))+20);
  i4 = i4!=0;
  
l17:
  if (!i4) goto l19;
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 18178))+20);
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i4, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i4, 18194)))), &_td_OOC_AST__FormalParsDesc, 18194)), 18205))+20);
  i4 = (OOC_INT32)OOC_AST_CreateSymTab__GetTypeParent((OOC_AST_CreateSymTab__Visitor)i3, (OOC_AST__Node)i4, (OOC_SymbolTable__Item)i2);
...
l19:
  *(OOC_INT32*)((_check_pointer(i1, 18270))+64) = i2;
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 18315))+8);
  i4 = i4!=0;
  if (!i4) goto l22;
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 18369))+8);
  OOC_AST_CreateSymTab__AcceptParent((OOC_AST_CreateSymTab__Visitor)i3, (OOC_AST__Node)i4, (OOC_SymbolTable__Item)i2);
l22:
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 18418))+20);
  i4 = i4!=0;
  if (!i4) goto l55;
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 18465))+20);
  i4 = _type_guard(i4, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i4, 18482)))), &_td_OOC_AST__FormalParsDesc, 18482);
  fpar = (OOC_AST__FormalPars)i4;
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i4, 18508));
  i5 = i5!=0;
  if (!i5) goto l27;
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i4, 18571));
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i5, 18577))+8);
  OOC_AST_CreateSymTab__ParseFormalParsFlags((OOC_SymbolTable__FormalPars)i2, (OOC_AST__NodeList)i5);
l27:
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 18614))+8);
  i5 = i5!=0;
  if (!i5) goto l42;
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 18665))+8);
  i = 0;
  i5 = *(OOC_INT32*)(_check_pointer(i5, 18677));
  i6 = 0<i5;
  if (!i6) goto l42;
  i6=0;
l32_loop:
  i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 18718))+8);
  i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 18730))+4);
  i7 = _check_pointer(i7, 18733);
  i8 = OOC_ARRAY_LENGTH(i7, 0);
  i7 = (OOC_INT32)*(OOC_INT32*)(i7+(_check_index(i6, i8, OOC_UINT32, 18733))*4);
  nodePtr = (OOC_AST__Node)i7;
  i8 = OOC_TYPE_TEST(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i7, 18760)))), &_td_OOC_AST__TerminalDesc);
  if (i8) goto l35;
  OOC_AST_CreateSymTab__AcceptParent((OOC_AST_CreateSymTab__Visitor)i3, (OOC_AST__Node)i7, (OOC_SymbolTable__Item)i2);
  goto l36;
l35:
  i7 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i7, 18826));
  i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 18831))+8);
  _assert(((
  _cmp8((const void*)(_check_pointer(i7, 18836)),(const void*)"..."))==0), 127, 18811);
...
l36:
  ...
  if (i7) goto l32_loop;
l42:
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 19012))+28);
  i5 = i5!=0;
  if (i5) goto l45;
  *(OOC_INT32*)((_check_pointer(i2, 19378))+60) = ((OOC_INT32)RT0__NewObject(_td_OOC_SymbolTable__ExceptionNameArray.baseTypes[0], 0));
  goto l55;
l45:
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 19072))+28);
  i5 = *(OOC_INT32*)(_check_pointer(i5, 19083));
  *(OOC_INT32*)((_check_pointer(i2, 19058))+60) = ((OOC_INT32)RT0__NewObject(_td_OOC_SymbolTable__ExceptionNameArray.baseTypes[0], ((i5+1)>>1)));
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 19125))+28);
  i = 0;
  i5 = *(OOC_INT32*)(_check_pointer(i5, 19137));
  i6 = 0<i5;
  if (!i6) goto l55;
  i6=0;
l48_loop:
  i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 19178))+28);
  i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 19190))+4);
  i7 = _check_pointer(i7, 19193);
  i8 = OOC_ARRAY_LENGTH(i7, 0);
  i7 = (OOC_INT32)*(OOC_INT32*)(i7+(_check_index(i6, i8, OOC_UINT32, 19193))*4);
  nodePtr = (OOC_AST__Node)i7;
  i7 = (OOC_INT32)OOC_AST_CreateSymTab__GetType((OOC_AST_CreateSymTab__Visitor)i3, (OOC_AST__Node)i7);
  type = (OOC_SymbolTable__Type)i7;
  i8 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 19257))+60);
  i8 = _check_pointer(i8, 19264);
  i9 = OOC_ARRAY_LENGTH(i8, 0);
  i10 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i3, 19292));
  i11 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i3, 19292));
  i7 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i10, 19296)))), OOC_SymbolTable_Builder__BuilderDesc_NewExceptionName)),OOC_SymbolTable_Builder__BuilderDesc_NewExceptionName)((OOC_SymbolTable_Builder__Builder)i11, (OOC_SymbolTable__Item)i2, (OOC_SymbolTable__Type)i7);
  *(OOC_INT32*)(i8+(_check_index((i6>>1), i9, OOC_UINT32, 19264))*4) = i7;
  i6 = i6+2;
  i = i6;
  i7 = i6<i5;
  if (i7) goto l48_loop;
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitFieldList(OOC_AST_CreateSymTab__Visitor v, OOC_AST__FieldList fieldList) {
  ...
  i4=0;
l3_loop:
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 19907));
  i6 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 19965));
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i6, 19976))+4);
  i6 = _check_pointer(i6, 19979);
  i7 = OOC_ARRAY_LENGTH(i6, 0);
  i6 = (OOC_INT32)*(OOC_INT32*)(i6+(_check_index(i4, i7, OOC_UINT32, 19979))*4);
  i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 19929))+4);
  i6 = (OOC_INT32)*(OOC_INT32*)(_check_pointer((_type_guard(i6, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i6, 19987)))), &_td_OOC_AST__IdentDefDesc, 19987)), 19996));
  i8 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 19907));
  i6 = (OOC_INT32)OOC_AST_CreateSymTab__GetName((OOC_AST__Node)i6);
  i9 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 20034))+8);
  i9 = OOC_AST_CreateSymTab__EndOfType((OOC_AST__Node)i9);
  i10 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 20072));
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i10, 20083))+4);
  i10 = _check_pointer(i10, 20086);
  i11 = OOC_ARRAY_LENGTH(i10, 0);
  i10 = (OOC_INT32)*(OOC_INT32*)(i10+(_check_index(i4, i11, OOC_UINT32, 20086))*4);
  i10 = OOC_AST_CreateSymTab__ExportMark((OOC_AST__Node)(_type_guard(i10, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i10, 20094)))), &_td_OOC_AST__IdentDefDesc, 20094)));
  i11 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 20124));
  i11 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i11, 20135))+4);
  i11 = _check_pointer(i11, 20138);
  i12 = OOC_ARRAY_LENGTH(i11, 0);
  i11 = (OOC_INT32)*(OOC_INT32*)(i11+(_check_index(i4, i12, OOC_UINT32, 20138))*4);
  i11 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i11, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i11, 20146)))), &_td_OOC_AST__IdentDefDesc, 20146)), 20155))+8);
  i5 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i5, 19912)))), OOC_SymbolTable_Builder__BuilderDesc_NewFieldDecl)),OOC_SymbolTable_Builder__BuilderDesc_NewFieldDecl)((OOC_SymbolTable_Builder__Builder)i8, (OOC_SymbolTable__Item)i7, (OOC_SymbolTable__Name)i6, i9, i10, (OOC_Doc__Document)i11, (OOC_SymbolTable__Type)i1);
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitTerminal(OOC_AST_CreateSymTab__Visitor v, OOC_AST__Terminal terminal) {
  ...
  i0 = (OOC_INT32)v;
  i1 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 20430));
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 20451))+4);
  i3 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 20430));
  i4 = (OOC_INT32)terminal;
  i5 = (OOC_INT32)OOC_AST_CreateSymTab__GetPosition((OOC_AST__Node)i4);
  i4 = (OOC_INT32)OOC_AST_CreateSymTab__GetName((OOC_AST__Node)i4);
  i1 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 20435)))), OOC_SymbolTable_Builder__BuilderDesc_NewTypeName)),OOC_SymbolTable_Builder__BuilderDesc_NewTypeName)((OOC_SymbolTable_Builder__Builder)i3, (OOC_SymbolTable__Item)i2, (OOC_SymbolTable__Position)i5, (OOC_SymbolTable__Name)0, (OOC_SymbolTable__Name)i4);
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitOperator(OOC_AST_CreateSymTab__Visitor v, OOC_AST__Operator _operator) {
  ...
  i0 = (OOC_INT32)v;
  i1 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 20657));
  i2 = (OOC_INT32)_operator;
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 20678))+4);
  i4 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 20709));
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 20657));
  i4 = (OOC_INT32)OOC_AST_CreateSymTab__GetPosition((OOC_AST__Node)i4);
  i6 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 20762));
  i6 = (OOC_INT32)OOC_AST_CreateSymTab__GetName((OOC_AST__Node)i6);
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 20788))+8);
  i2 = (OOC_INT32)OOC_AST_CreateSymTab__GetName((OOC_AST__Node)i2);
  i1 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 20662)))), OOC_SymbolTable_Builder__BuilderDesc_NewTypeName)),OOC_SymbolTable_Builder__BuilderDesc_NewTypeName)((OOC_SymbolTable_Builder__Builder)i5, (OOC_SymbolTable__Item)i3, (OOC_SymbolTable__Position)i4, (OOC_SymbolTable__Name)i6, (OOC_SymbolTable__Name)i2);
...
l4:
  i2 = (OOC_INT32)v;
  i3 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 21117));
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 21136))+4);
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 21169));
  i6 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 21117));
  i5 = (OOC_INT32)OOC_AST_CreateSymTab__GetPosition((OOC_AST__Node)i5);
  i1 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i3, 21122)))), OOC_SymbolTable_Builder__BuilderDesc_NewRecord)),OOC_SymbolTable_Builder__BuilderDesc_NewRecord)((OOC_SymbolTable_Builder__Builder)i6, (OOC_SymbolTable__Item)i4, (OOC_SymbolTable__Position)i5, (OOC_SymbolTable__Type)i1);
  record = (OOC_SymbolTable__Record)i1;
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 21255))+4);
  OOC_AST_CreateSymTab__AddFlags((OOC_SymbolTable__Item)i1, (OOC_AST__Flags)i3);
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 21292))+20);
  i = 0;
  i3 = *(OOC_INT32*)(_check_pointer(i3, 21304));
  i4 = 0<i3;
  if (!i4) goto l15;
  i4=0;
l7_loop:
...
l10:
  ...
  if (i5) goto l7_loop;
l15:
  *(OOC_INT32*)((_check_pointer(i2, 21458))+8) = i1;
  return;
  ;
}
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitPointerType(OOC_AST_CreateSymTab__Visitor v, OOC_AST__PointerType pointerType) {
  ...
  i0 = (OOC_INT32)v;
  i1 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 21596));
  i2 = (OOC_INT32)pointerType;
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 21616))+4);
  i4 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 21685));
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 21596));
  i4 = (OOC_INT32)OOC_AST_CreateSymTab__GetPosition((OOC_AST__Node)i4);
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 21755))+12);
  i6 = (OOC_INT32)OOC_AST_CreateSymTab__GetType((OOC_AST_CreateSymTab__Visitor)i0, (OOC_AST__Node)i6);
  i1 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 21601)))), OOC_SymbolTable_Builder__BuilderDesc_NewPointer)),OOC_SymbolTable_Builder__BuilderDesc_NewPointer)((OOC_SymbolTable_Builder__Builder)i5, (OOC_SymbolTable__Item)i3, (OOC_SymbolTable__Position)i4, (OOC_SymbolTable__Type)i6);
  *(OOC_INT32*)((_check_pointer(i0, 21585))+8) = i1;
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 21797))+4);
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitArrayType(OOC_AST_CreateSymTab__Visitor v, OOC_AST__ArrayType arrayType) {
  ...
  if (i1) goto l3;
  i1 = (OOC_INT32)v;
  i2 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i1, 22582));
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 22600))+4);
  i4 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 22632));
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i1, 22582));
  i4 = (OOC_INT32)OOC_AST_CreateSymTab__GetPosition((OOC_AST__Node)i4);
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 22707))+16);
  i6 = (OOC_INT32)OOC_AST_CreateSymTab__GetType((OOC_AST_CreateSymTab__Visitor)i1, (OOC_AST__Node)i6);
  i2 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 22587)))), OOC_SymbolTable_Builder__BuilderDesc_NewArray)),OOC_SymbolTable_Builder__BuilderDesc_NewArray)((OOC_SymbolTable_Builder__Builder)i5, (OOC_SymbolTable__Item)i3, (OOC_SymbolTable__Position)i4, 1u, (OOC_AST__Node)0, (OOC_SymbolTable__Type)i6);
  array = (OOC_SymbolTable__Array)i2;
  i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 22748))+4);
  OOC_AST_CreateSymTab__AddFlags((OOC_SymbolTable__Item)i2, (OOC_AST__Flags)i0);
  i0=i1;i1=i2;
  goto l17;
l3:
...
l11:
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 22324));
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 22424))+8);
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i6, 22434))+4);
  i6 = _check_pointer(i6, 22437);
  i7 = OOC_ARRAY_LENGTH(i6, 0);
  i8 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 22354))+4);
  i6 = (OOC_INT32)*(OOC_INT32*)(i6+(_check_index(i1, i7, OOC_UINT32, 22437))*4);
  i7 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 22324));
  i3 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i5, 22329)))), OOC_SymbolTable_Builder__BuilderDesc_NewArray)),OOC_SymbolTable_Builder__BuilderDesc_NewArray)((OOC_SymbolTable_Builder__Builder)i7, (OOC_SymbolTable__Item)i8, (OOC_SymbolTable__Position)i4, 0u, (OOC_AST__Node)i6, (OOC_SymbolTable__Type)i3);
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitProcType(OOC_AST_CreateSymTab__Visitor v, OOC_AST__ProcType procType) {
  ...
  i0 = (OOC_INT32)v;
  i1 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 23052));
  i2 = (OOC_INT32)procType;
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 23075))+4);
  i4 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i2, 23145));
  i5 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 23052));
  i4 = (OOC_INT32)OOC_AST_CreateSymTab__GetPosition((OOC_AST__Node)i4);
  i1 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 23057)))), OOC_SymbolTable_Builder__BuilderDesc_NewFormalPars)),OOC_SymbolTable_Builder__BuilderDesc_NewFormalPars)((OOC_SymbolTable_Builder__Builder)i5, (OOC_SymbolTable__Item)i3, (OOC_SymbolTable__Position)i4);
  formalPars = (OOC_SymbolTable__FormalPars)i1;
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 23176))+4);
  i3 = i3!=0;
  if (i3) goto l3;
  i3=0u;
  goto l5;
l3:
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 23214))+4);
...
l5:
  if (!i3) goto l7;
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 23330))+4);
  ...
  i3 = (OOC_INT32)OOC_AST_CreateSymTab__GetTypeParent((OOC_AST_CreateSymTab__Visitor)i0, (OOC_AST__Node)i3, (OOC_SymbolTable__Item)i1);
  OOC_SymbolTable__FormalParsDesc_SetResultType((OOC_SymbolTable__FormalPars)i1, (OOC_SymbolTable__Type)i3);
l7:
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 23430))+4);
  i3 = i3!=0;
  if (!i3) goto l13;
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 23477))+4);
...
l13:
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 23646))+4);
  i3 = i3!=0;
  if (!i3) goto l39;
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 23693))+4);
  i2 = _type_guard(i2, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 23710)))), &_td_OOC_AST__FormalParsDesc, 23710);
  fpar = (OOC_AST__FormalPars)i2;
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 23737))+8);
  i3 = i3!=0;
  if (!i3) goto l26;
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 23788))+8);
  i = 0;
  ...
  i4=0;
l20_loop:
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 23847))+8);
  ...
  OOC_AST_CreateSymTab__AcceptParent((OOC_AST_CreateSymTab__Visitor)i0, (OOC_AST__Node)i5, (OOC_SymbolTable__Item)i1);
  i4 = i4+2;
  i = i4;
  i5 = i4<i3;
  if (i5) goto l20_loop;
l26:
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 23924))+28);
  i3 = i3!=0;
  if (i3) goto l29;
  *(OOC_INT32*)((_check_pointer(i1, 24290))+60) = ((OOC_INT32)RT0__NewObject(_td_OOC_SymbolTable__ExceptionNameArray.baseTypes[0], 0));
  goto l39;
l29:
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 23984))+28);
  ...
  *(OOC_INT32*)((_check_pointer(i1, 23970))+60) = ((OOC_INT32)RT0__NewObject(_td_OOC_SymbolTable__ExceptionNameArray.baseTypes[0], ((i3+1)>>1)));
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 24037))+28);
  i = 0;
  ...
  i4=0;
l32_loop:
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 24090))+28);
  ...
  i5 = (OOC_INT32)OOC_AST_CreateSymTab__GetType((OOC_AST_CreateSymTab__Visitor)i0, (OOC_AST__Node)i5);
  type = (OOC_SymbolTable__Type)i5;
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 24169))+60);
  i6 = _check_pointer(i6, 24176);
  i7 = OOC_ARRAY_LENGTH(i6, 0);
  i8 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 24204));
  i9 = (OOC_INT32)*(OOC_INT32*)(_check_pointer(i0, 24204));
  ...
  *(OOC_INT32*)(i6+(_check_index((i4>>1), i7, OOC_UINT32, 24176))*4) = i5;
  ...
  if (i5) goto l32_loop;
l39:
  *(OOC_INT32*)((_check_pointer(i0, 24328))+8) = i1;
  return;
  ;
}
...
void OOC_AST_CreateSymTab__VisitorDesc_VisitQualType(OOC_AST_CreateSymTab__Visitor v, OOC_AST__QualType qualType) {
  ...
  i6=0;
l3_loop:
  i7 = _check_pointer(i3, 24706);
  i8 = OOC_ARRAY_LENGTH(i7, 0);
  i9 = i6>>1;
  i10 = OOC_ARRAY_LENGTH((_check_pointer(i3, 24706)), 0);
  i10 = _check_index(i9, i10, OOC_UINT32, 24706);
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 24758))+8);
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i10, 24768))+4);
  i10 = _check_pointer(i10, 24770);
  i11 = OOC_ARRAY_LENGTH(i10, 0);
  i10 = (OOC_INT32)*(OOC_INT32*)(i10+(_check_index(i6, i11, OOC_UINT32, 24770))*4);
  i10 = (OOC_INT32)OOC_AST_CreateSymTab__GetType((OOC_AST_CreateSymTab__Visitor)i2, (OOC_AST__Node)i10);
  OOC_SymbolTable__InitTypeRef((void*)(i7+(_check_index(i9, i8, OOC_UINT32, 24706))*8), (RT0__Struct)i5, (OOC_SymbolTable__Type)i10);
  i6 = i6+2;
  i = i6;
  i7 = i6<i4;
  if (i7) goto l3_loop;
