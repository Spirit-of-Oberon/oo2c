...
void OOC_OOC_Config_StdPragmas_init(void) {
  _c0 = Object__NewLatin1Region((OOC_CHAR8*)"Warnings", 9, 0, 8);
  _c1 = Object__NewLatin1Region((OOC_CHAR8*)"Assertions", 11, 0, 10);
  _c2 = Object__NewLatin1Region((OOC_CHAR8*)"StackCheck", 11, 0, 10);
  _c3 = Object__NewLatin1Region((OOC_CHAR8*)"ConformantMode", 15, 0, 14);
  _c4 = Object__NewLatin1Region((OOC_CHAR8*)"IndexCheck", 11, 0, 10);
  _c5 = Object__NewLatin1Region((OOC_CHAR8*)"DerefCheck", 11, 0, 10);
  _c6 = Object__NewLatin1Region((OOC_CHAR8*)"OverflowCheck", 14, 0, 13);
  _c7 = Object__NewLatin1Region((OOC_CHAR8*)"CaseSelectCheck", 16, 0, 15);
  _c8 = Object__NewLatin1Region((OOC_CHAR8*)"FunctResult", 12, 0, 11);
  _c9 = Object__NewLatin1Region((OOC_CHAR8*)"TypeGuard", 10, 0, 9);
  _c10 = Object__NewLatin1Region((OOC_CHAR8*)"RangeCheck", 11, 0, 10);
  _c11 = Object__NewLatin1Region((OOC_CHAR8*)"OOC", 4, 0, 3);
  _c12 = Object__NewLatin1Region((OOC_CHAR8*)"COMPILER", 9, 0, 8);
  _c13 = Object__NewLatin1Region((OOC_CHAR8*)"2.1.11", 7, 0, 6);
  _c14 = Object__NewLatin1Region((OOC_CHAR8*)"COMPILER_VERSION", 17, 0, 16);
  _c15 = Object__NewLatin1Region((OOC_CHAR8*)"COMPILER_MAJOR", 15, 0, 14);
  _c16 = Object__NewLatin1Region((OOC_CHAR8*)"COMPILER_MINOR", 15, 0, 14);
  _c17 = Object__NewLatin1Region((OOC_CHAR8*)"Unix", 5, 0, 4);
  _c18 = Object__NewLatin1Region((OOC_CHAR8*)"TARGET_OS", 10, 0, 9);
  _c19 = Object__NewLatin1Region((OOC_CHAR8*)"gcc", 4, 0, 3);
  _c20 = Object__NewLatin1Region((OOC_CHAR8*)"TARGET_ARCH", 12, 0, 11);
  _c21 = Object__NewLatin1Region((OOC_CHAR8*)"", 1, 0, 0);
  _c22 = Object__NewLatin1Region((OOC_CHAR8*)"TARGET_ARCH_MINOR", 18, 0, 17);
  _c23 = Object__NewLatin1Region((OOC_CHAR8*)"TARGET_INTEGER", 15, 0, 14);
  _c24 = Object__NewLatin1Region((OOC_CHAR8*)"TARGET_ADDRESS", 15, 0, 14);
  _c25 = Object__NewLatin1Region((OOC_CHAR8*)"unknown", 8, 0, 7);
  _c26 = Object__NewLatin1Region((OOC_CHAR8*)"TARGET_BYTE_ORDER", 18, 0, 17);

  return;
  ;
}

void OOC_OOC_Config_StdPragmas_destroy(void) {
}
