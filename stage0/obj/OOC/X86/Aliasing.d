...
static RT0__ModuleDesc _mid = { (OOC_CHAR8*)"OOC:X86:Aliasing", (RT0__Struct[]) { NULL }, 0 };

extern void OOC_OOC_X86_Aliasing_open(RT0__Module client) {
  if (_mid.openCount == 0) {
...
extern void OOC_OOC_X86_Aliasing_close(RT0__Module client) {
  _mid.openCount--;
  if (_mid.openCount == 0) { 
    OOC_OOC_X86_Aliasing_destroy();
