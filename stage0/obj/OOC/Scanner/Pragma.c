...
static OOC_INT8 OOC_Scanner_Pragma__ParsePragma(struct OOC_Scanner_Pragma__State *state, RT0__Struct state__tag) {
  ...
  auto void OOC_Scanner_Pragma__ParsePragma_Assignment(OOC_CHAR8 define, OOC_CHAR8 eval);
    ...
    void OOC_Scanner_Pragma__ParsePragma_AppendErr(OOC_Scanner_SymList__Symbol sym) {
      ...
      i1 = (OOC_INT32)sym;
      i2 = *(OOC_INT32*)((_check_pointer(i1, 6250))+16);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 6224)))), Msg__MsgDesc_SetIntAttrib)),Msg__MsgDesc_SetIntAttrib)((Msg__Msg)i0, "pos", 4, i2);
      i0 = (OOC_INT32)lastError;
      i2 = *(OOC_INT32*)((_check_pointer(i1, 6300))+20);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 6273)))), Msg__MsgDesc_SetIntAttrib)),Msg__MsgDesc_SetIntAttrib)((Msg__Msg)i0, "line", 5, i2);
      i0 = (OOC_INT32)lastError;
      i1 = *(OOC_INT32*)((_check_pointer(i1, 6353))+24);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 6324)))), Msg__MsgDesc_SetIntAttrib)),Msg__MsgDesc_SetIntAttrib)((Msg__Msg)i0, "column", 7, i1);
    ...
    void OOC_Scanner_Pragma__ParsePragma_CheckName(OOC_Scanner_SymList__Symbol sym) {
      ...
      i2 = (
      _cmp8((const void*)(_check_pointer(i1, 6726)),(const void*)"TRUE"))==0;
      if (i2) goto l3;
      i2 = (
      _cmp8((const void*)(_check_pointer(i1, 6746)),(const void*)"FALSE"))==0;
...
l5:
      if (i2) goto l7;
      i2 = (
      _cmp8((const void*)(_check_pointer(i1, 6767)),(const void*)"PUSH"))==0;
...
l9:
      if (i2) goto l11;
      i2 = (
      _cmp8((const void*)(_check_pointer(i1, 6797)),(const void*)"POP"))==0;
...
l13:
      if (i2) goto l15;
      i1 = (
      _cmp8((const void*)(_check_pointer(i1, 6816)),(const void*)"DEFINE"))==0;
...
l7:
      i0 = (OOC_INT32)lastError;
      i1 = (OOC_INT32)Msg__GetStringPtr((void*)((OOC_INT32)OOC_Scanner_Symbol__representation+((_check_index(i2, 81, OOC_UINT8, 7645))*10)), 10);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 7544)))), Msg__MsgDesc_SetStringAttrib)),Msg__MsgDesc_SetStringAttrib)((Msg__Msg)i0, "sym_name", 9, (Msg__StringPtr)i1);
      i0 = (OOC_INT32)sym;
...
l8:
                  ...
                  *(OOC_INT32*)((OOC_INT32)value+4) = i0;
                  ...
                  case 45:
                    ...
                    i1 = (
                    _cmp8((const void*)(_check_pointer(i1, 9560)),(const void*)"FALSE"))==0;
                    if (i1) goto l5;
                    i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 9580))+8);
                    i1 = (
                    _cmp8((const void*)(_check_pointer(i1, 9585)),(const void*)"TRUE"))==0;
...
l7:
                    ...
                    i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 9906))+8);
                    i2 = (OOC_INT32)*(OOC_INT32*)((OOC_INT32)state+36);
                    i0 = OOC_ARRAY_LENGTH((_check_pointer(i0, 9910)), 0);
                    i0 = (OOC_INT32)Object__NewLatin1((void*)(_check_pointer(i1, 9910)), i0);
                    i1 = (OOC_INT32)sym;
                    i1 = *(OOC_INT32*)((_check_pointer(i1, 9917))+16);
                    i0 = (OOC_INT32)OOC_Config_Pragmas__HistoryDesc_GetValue((OOC_Config_Pragmas__History)i2, (Object__String)i0, i1);
                    i1 = i0!=0;
                    if (i1) goto l14;
                    i0 = eval;
                    if (!i0) goto l17;
...
l16:
                    ...
                    _cmp8((const void*)(_check_pointer(i0, 9703)),(const void*)"TRUE"))==0));
                    *(OOC_INT32*)(OOC_INT32)value = i0;
l17:
                    OOC_Scanner_Pragma__ParsePragma_NextSym();
                    goto l30;
...
l25:
                  ...
                  case 43:
                  case 44:
                    i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 10958))+8);
                    i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 10958))+8);
                    i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 11026))+8);
                    i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 11026))+8);
                    i0 = OOC_ARRAY_LENGTH((_check_pointer(i0, 11030)), 0);
                    i0 = Strings__Length((void*)(_check_pointer(i3, 11030)), i0);
                    i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 10962)), 0);
                    i0 = (OOC_INT32)Object__NewLatin1Region((void*)(_check_pointer(i1, 10962)), i2, 1, (i0-1));
...
l6:
      ...
      i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 16385))+8);
      i3 = (OOC_INT32)state+36;
      i4 = (OOC_INT32)*(OOC_INT32*)i3;
      i0 = OOC_ARRAY_LENGTH((_check_pointer(i0, 16390)), 0);
      i0 = (OOC_INT32)Object__NewLatin1((void*)(_check_pointer(i2, 16390)), i0);
      i2 = (OOC_INT32)sym;
      i2 = *(OOC_INT32*)((_check_pointer(i2, 16397))+16);
      i0 = (OOC_INT32)OOC_Config_Pragmas__HistoryDesc_GetValue((OOC_Config_Pragmas__History)i4, (Object__String)i0, i2);
...
l37:
      ...
      i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 17417))+8);
      i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 17421)), 0);
      i3 = (OOC_INT32)*(OOC_INT32*)i3;
      i0 = (OOC_INT32)Object__NewLatin1((void*)(_check_pointer(i0, 17421)), i1);
      i1 = *(OOC_INT32*)((_check_pointer(i2, 17429))+16);
      i2 = (OOC_INT32)*(OOC_INT32*)(OOC_INT32)&value;
      OOC_Config_Pragmas__HistoryDesc_SetValue((OOC_Config_Pragmas__History)i3, (Object__String)i0, i1, (Config__Variable)i2);
      i0 = err;
      if (!i0) goto l45;
      i0 = (OOC_INT32)*(OOC_INT32*)((OOC_INT32)&value+4);
...
l41:
      ...
      i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 16939))+8);
      i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 16943)), 0);
      i3 = (OOC_INT32)*(OOC_INT32*)i3;
      i0 = (OOC_INT32)Object__NewLatin1((void*)(_check_pointer(i0, 16943)), i1);
      i1 = *(OOC_INT32*)((_check_pointer(i2, 16951))+16);
      i2 = (OOC_INT32)*(OOC_INT32*)(OOC_INT32)&value;
      OOC_Config_Pragmas__HistoryDesc_SetValue((OOC_Config_Pragmas__History)i3, (Object__String)i0, i1, (Config__Variable)i2);
l45:
      return;
...
l22:
  ...
  i4 = (
  _cmp8((const void*)(_check_pointer(i4, 19589)),(const void*)"DEFINE"))==0;
...
l28:
  ...
  i4 = (
  _cmp8((const void*)(_check_pointer(i4, 19716)),(const void*)"PUSH"))==0;
...
l34:
  ...
  i4 = (
  _cmp8((const void*)(_check_pointer(i4, 19881)),(const void*)"POP"))==0;
...
void OOC_Scanner_Pragma__AddSymbol(struct OOC_Scanner_Pragma__State *state, RT0__Struct state__tag, OOC_INT8 *inputMode, OOC_INT8 id, OOC_INT32 cstart, OOC_INT32 cend, OOC_INT32 line, OOC_INT32 column) {
  ...
  auto void OOC_Scanner_Pragma__AddSymbol_EndOfFile(void);
    ...
    void OOC_Scanner_Pragma__AddSymbol_Err(OOC_INT32 code) {
      ...
      i2 = cstart;
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 21621)))), Msg__MsgDesc_SetIntAttrib)),Msg__MsgDesc_SetIntAttrib)((Msg__Msg)i0, "pos", 4, (i2+i1));
      i0 = (OOC_INT32)lastError;
      i1 = line;
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 21698)))), Msg__MsgDesc_SetIntAttrib)),Msg__MsgDesc_SetIntAttrib)((Msg__Msg)i0, "line", 5, i1);
      i0 = (OOC_INT32)lastError;
      i1 = column;
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 21744)))), Msg__MsgDesc_SetIntAttrib)),Msg__MsgDesc_SetIntAttrib)((Msg__Msg)i0, "column", 7, i1);
      i0 = (OOC_INT32)*(OOC_INT32*)(OOC_INT32)state;
    ...
    void OOC_Scanner_Pragma__AddSymbol_ErrSym(OOC_INT32 code, OOC_Scanner_SymList__Symbol sym) {
      ...
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 21981)))), Msg__MsgDesc_SetIntAttrib)),Msg__MsgDesc_SetIntAttrib)((Msg__Msg)i0, "pos", 4, i2);
      i0 = (OOC_INT32)lastError;
      i2 = *(OOC_INT32*)((_check_pointer(i1, 22057))+20);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 22030)))), Msg__MsgDesc_SetIntAttrib)),Msg__MsgDesc_SetIntAttrib)((Msg__Msg)i0, "line", 5, i2);
      i0 = (OOC_INT32)lastError;
      i1 = *(OOC_INT32*)((_check_pointer(i1, 22110))+24);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 22081)))), Msg__MsgDesc_SetIntAttrib)),Msg__MsgDesc_SetIntAttrib)((Msg__Msg)i0, "column", 7, i1);
      i0 = (OOC_INT32)*(OOC_INT32*)(OOC_INT32)state;
    ...
    void OOC_Scanner_Pragma__AddSymbol_EndOfFile(void) {
      ...
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 22471)))), Msg__MsgDesc_SetIntAttrib)),Msg__MsgDesc_SetIntAttrib)((Msg__Msg)i0, "pos", 4, i1);
      i0 = (OOC_INT32)lastError;
      i1 = *(OOC_INT32*)((OOC_INT32)state+28);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 22530)))), Msg__MsgDesc_SetIntAttrib)),Msg__MsgDesc_SetIntAttrib)((Msg__Msg)i0, "line", 5, i1);
      i0 = (OOC_INT32)lastError;
      i1 = *(OOC_INT32*)((OOC_INT32)state+32);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 22588)))), Msg__MsgDesc_SetIntAttrib)),Msg__MsgDesc_SetIntAttrib)((Msg__Msg)i0, "column", 7, i1);
...
l12:
      ...
      i3 = line;
      i4 = column;
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 23339)))), OOC_Scanner_SymList__BuilderDesc_AddSymbol)),OOC_Scanner_SymList__BuilderDesc_AddSymbol)((OOC_Scanner_SymList__Builder)i0, 72, i1, i2, i3, i4);
      goto l33;
    default:
