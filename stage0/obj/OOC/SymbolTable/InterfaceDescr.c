...
void OOC_SymbolTable_InterfaceDescr__Write(IO__ByteChannel cw, URI__HierarchicalURI baseURI, OOC_SymbolTable__Module module, OOC_Config_Repositories__Section repositories, ADT_Dictionary__Dictionary extensionDict) {
  ...
  auto void OOC_SymbolTable_InterfaceDescr__Write_WriteKnownExtensions(Object__Object type);
    ...
    void OOC_SymbolTable_InterfaceDescr__Write_WriteReference(const OOC_CHAR16 tagName__ref[], OOC_LEN tagName_0d, OOC_SymbolTable__Declaration decl) {
      ...
      i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 3107))+20);
      i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 3113))+12);
      i4 = OOC_ARRAY_LENGTH((_check_pointer(i4, 3118)), 0);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 3067)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i2, ((OOC_CHAR16[]){109,111,100,117,108,101,0}), 7, (void*)(_check_pointer(i3, 3118)), i4);
      i2 = (OOC_INT32)w;
      i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 3161))+20);
      i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 3167))+12);
      i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 3161))+20);
      i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 3167))+12);
      i4 = OOC_ARRAY_LENGTH((_check_pointer(i4, 3172)), 0);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 3129)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i2, ((OOC_CHAR16[]){110,97,109,101,0}), 5, (void*)(_check_pointer(i3, 3172)), i4);
      i2 = (OOC_INT32)OOC_SymbolTable_GetClass__GetClass((OOC_SymbolTable__Item)i0);
      className = (OOC_SymbolTable__Name)i2;
      i3 = (OOC_INT32)w;
      i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 3266))+12);
      i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 3266))+12);
      i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 3271)), 0);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i3, 3228)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i3, ((OOC_CHAR16[]){99,108,97,115,115,0}), 6, (void*)(_check_pointer(i4, 3271)), i2);
      i2 = (OOC_INT32)module;
      i2 = i2==i1;
      if (i2) goto l3;
...
l4:
      ...
      i0 = (OOC_INT32)OOC_Config_Repositories__SectionDesc_GetModule((OOC_Config_Repositories__Section)i2, (void*)(_check_pointer(i0, 3665)), i1);
      i1 = i0!=(OOC_INT32)0;
      if (!i1) goto l10;
...
l7:
      ...
      i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 5317))+64);
      i3 = (OOC_INT32)decl;
      i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i3, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i3, 5377)))), &_td_OOC_SymbolTable__ProcDeclDesc, 5377)), 5386))+64);
      i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 5329))+40);
      i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 5398))+40);
      ADT_Dictionary__DictionaryDesc_Set((ADT_Dictionary__Dictionary)i1, (Object__Object)i2, (Object__Object)i4);
      i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 5447))+64);
      i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 5459))+52);
      i = 0;
      i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 5467)), 0);
      i4 = 0<i2;
      if (!i4) goto l18;
      i4=0;
l13_loop:
      i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 5511))+64);
      i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i5, 5523))+52);
      i5 = _check_pointer(i5, 5531);
      i6 = OOC_ARRAY_LENGTH(i5, 0);
      i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i3, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i3, 5574)))), &_td_OOC_SymbolTable__ProcDeclDesc, 5574)), 5583))+64);
      i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 5595))+52);
      i7 = _check_pointer(i7, 5603);
      i8 = OOC_ARRAY_LENGTH(i7, 0);
      i5 = (OOC_INT32)*(OOC_INT32*)(i5+(_check_index(i4, i6, OOC_UINT32, 5531))*4);
      i6 = (OOC_INT32)*(OOC_INT32*)(i7+(_check_index(i4, i8, OOC_UINT32, 5603))*4);
...
l22:
    ...
    void OOC_SymbolTable_InterfaceDescr__Write_DeclAttr(OOC_SymbolTable__Declaration decl) {
      ...
      i0 = (OOC_INT32)w;
      i1 = (OOC_INT32)decl;
      i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 5944))+20);
      i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 5950))+12);
      i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 5944))+20);
      i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 5950))+12);
      i3 = OOC_ARRAY_LENGTH((_check_pointer(i3, 5955)), 0);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 5912)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i0, ((OOC_CHAR16[]){110,97,109,101,0}), 5, (void*)(_check_pointer(i2, 5955)), i3);
      i0 = (OOC_INT32)declDict;
      i0 = ADT_Dictionary__DictionaryDesc_HasKey((ADT_Dictionary__Dictionary)i0, (Object__Object)i1);
      i0 = !i0;
      if (!i0) goto l4;
      i0 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 6321)))), OOC_SymbolTable__DeclarationDesc_GetId)),OOC_SymbolTable__DeclarationDesc_GetId)((OOC_SymbolTable__Declaration)i1);
      id = (OOC_Scanner_InputBuffer__CharArray)i0;
      i2 = (OOC_INT32)w;
      i3 = OOC_ARRAY_LENGTH((_check_pointer(i0, 6369)), 0);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 6341)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i2, ((OOC_CHAR16[]){105,100,0}), 3, (void*)(_check_pointer(i0, 6369)), i3);
      i0 = (OOC_INT32)declDict;
...
l13:
          ...
          i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 10872))+44);
          i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 10894))+40);
          ...
          i2=0;
l16_loop:
          i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 11038))+48);
          i3 = _check_pointer(i3, 11048);
          i4 = OOC_ARRAY_LENGTH(i3, 0);
          i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 11100))+48);
          i5 = _check_pointer(i5, 11110);
          i6 = OOC_ARRAY_LENGTH(i5, 0);
          i3 = (OOC_INT32)*(OOC_INT32*)((i3+(_check_index(i2, i4, OOC_UINT32, 11048))*8)+4);
          i4 = (OOC_INT32)*(OOC_INT32*)(i5+(_check_index(i2, i6, OOC_UINT32, 11110))*8);
...
l37:
          ...
          i2=0;
l42_loop:
          i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 10606))+60);
          i3 = _check_pointer(i3, 10613);
          i4 = OOC_ARRAY_LENGTH(i3, 0);
          i3 = (OOC_INT32)*(OOC_INT32*)(i3+(_check_index(i2, i4, OOC_UINT32, 10613))*4);
          i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 10667))+60);
          i4 = _check_pointer(i4, 10674);
          i5 = OOC_ARRAY_LENGTH(i4, 0);
          i4 = (OOC_INT32)*(OOC_INT32*)(i4+(_check_index(i2, i5, OOC_UINT32, 10674))*4);
          i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 10616))+24);
          i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 10677))+20);
          OOC_SymbolTable_InterfaceDescr__Write_WriteItem_WriteTypeComponent((OOC_SymbolTable__Type)i3, (OOC_SymbolTable__Type)i4);
          i2 = i2+1;
          j = i2;
          i3 = i2<i1;
...
l68:
          ...
          i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 9367))+44);
          i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 9390))+40);
...
l81:
          ...
          i3 = (OOC_INT32)w;
          i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 8216))+20);
          i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 8222))+12);
          i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 8216))+20);
          i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 8222))+12);
          i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 8227)), 0);
          OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i3, 8180)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i3, ((OOC_CHAR16[]){109,111,100,117,108,101,0}), 7, (void*)(_check_pointer(i4, 8227)), i1);
          goto l85;
l84:
          i3 = (OOC_INT32)w;
          i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 7761))+12);
          i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 7761))+12);
          i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 7766)), 0);
          OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i3, 7721)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i3, ((OOC_CHAR16[]){109,111,100,117,108,101,0}), 7, (void*)(_check_pointer(i4, 7766)), i1);
l85:
          i1 = (OOC_INT32)w;
          i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 8288))+44);
          i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 8295))+12);
          i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 8288))+44);
          i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 8295))+12);
          i4 = OOC_ARRAY_LENGTH((_check_pointer(i4, 8300)), 0);
          OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 8256)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i1, ((OOC_CHAR16[]){110,97,109,101,0}), 5, (void*)(_check_pointer(i3, 8300)), i4);
          if (i2) goto l88;
          i1 = (OOC_INT32)resolvedType;
          i1 = i1==(OOC_INT32)0;
...
l99:
          ...
          i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 8857)), 0);
          i3 = (OOC_INT32)repositories;
          i1 = (OOC_INT32)OOC_Config_Repositories__SectionDesc_GetModule((OOC_Config_Repositories__Section)i3, (void*)(_check_pointer(i2, 8857)), i1);
...
l103:
          ...
          Strings__Append((void*)(_check_pointer(i1, 9133)), i0, (void*)(OOC_INT32)href, 2048);
          goto l105;
l104:
...
l3_loop:
          ...
          i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 12337))+20);
          i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 12342))+12);
          i3 = OOC_ARRAY_LENGTH((_check_pointer(i3, 12346)), 0);
          OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 12310)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i1, ((OOC_CHAR16[]){110,97,109,101,0}), 5, (void*)(_check_pointer(i2, 12346)), i3);
...
l11:
      ...
      i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 16174))+64);
      i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 16192))+64);
      ...
      i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 16301))+20);
...
l24:
      ...
      i0 = (OOC_INT32)item;
      OOC_SymbolTable_InterfaceDescr__Write_DeclDocString((OOC_SymbolTable__Declaration)i0);
      i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 15915))+52);
      i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 15934))+48);
...
l40:
      OOC_SymbolTable_InterfaceDescr__Write_DeclDocString((OOC_SymbolTable__Declaration)i0);
      i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 15337))+52);
      i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 15356))+48);
      OOC_SymbolTable_InterfaceDescr__Write_WriteItem_WriteType(((OOC_CHAR16[]){116,121,112,101,0}), 5, (OOC_SymbolTable__Type)i1, (OOC_SymbolTable__Type)i0);
      i0 = (OOC_INT32)item;
...
l45:
      ...
      goto l49;
l48:
      i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 14555))+48);
      i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 14615))+48);
      i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i1, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 14565)))), &_td_OOC_SymbolTable__TypeVarDesc, 14565)), 14573))+44);
      i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i0, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 14625)))), &_td_OOC_SymbolTable__TypeVarDesc, 14625)), 14633))+40);
      OOC_SymbolTable_InterfaceDescr__Write_WriteItem_WriteType(((OOC_CHAR16[]){116,121,112,101,0}), 5, (OOC_SymbolTable__Type)i1, (OOC_SymbolTable__Type)i0);
l49:
      i0 = (OOC_INT32)item;
...
l56:
      ...
      i0 = (OOC_INT32)w;
      i1 = (OOC_INT32)item;
      i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 14001))+48);
      i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 14013))+12);
      i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 14001))+48);
      i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 14013))+12);
      i3 = OOC_ARRAY_LENGTH((_check_pointer(i3, 14018)), 0);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 13967)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i0, ((OOC_CHAR16[]){109,111,100,117,108,101,0}), 7, (void*)(_check_pointer(i2, 14018)), i3);
      i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 14081))+48);
      i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 14093))+12);
      i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 14081))+48);
      i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 14093))+12);
      i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 14098)), 0);
      i3 = (OOC_INT32)repositories;
      i0 = (OOC_INT32)OOC_Config_Repositories__SectionDesc_GetModule((OOC_Config_Repositories__Section)i3, (void*)(_check_pointer(i0, 14098)), i2);
...
l61:
      ...
      i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 13642)), 0);
      i3 = (OOC_INT32)repositories;
      i1 = (OOC_INT32)OOC_Config_Repositories__SectionDesc_GetModule((OOC_Config_Repositories__Section)i3, (void*)(_check_pointer(i1, 13642)), i2);
...
l11:
    ...
    void OOC_SymbolTable_InterfaceDescr__Write_WriteModuleRef(ADT_Dictionary__Dictionary modList) {
      ...
      i0 = OOC_ARRAY_LENGTH((_check_pointer(i0, 17074)), 0);
      i2 = (OOC_INT32)repositories;
      i0 = (OOC_INT32)OOC_Config_Repositories__SectionDesc_GetModule((OOC_Config_Repositories__Section)i2, (void*)(_check_pointer(i1, 17074)), i0);
...
l3_loop:
      ...
      i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 17366))+4);
      i7 = OOC_ARRAY_LENGTH((_check_pointer(i7, 17372)), 0);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i5, 17329)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i5, ((OOC_CHAR16[]){110,97,109,101,0}), 5, (void*)(_check_pointer(i6, 17372)), i7);
      i5 = (OOC_INT32)w;
      ...
      i5 = (OOC_INT32)w;
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i5, 17429)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i5, ((OOC_CHAR16[]){116,121,112,101,0}), 5, "html", 5);
...
l11:
          ...
          i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 18562))+20);
          i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 18568))+12);
          i4 = OOC_ARRAY_LENGTH((_check_pointer(i4, 18573)), 0);
          OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 18526)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i2, ((OOC_CHAR16[]){109,111,100,117,108,101,0}), 7, (void*)(_check_pointer(i3, 18573)), i4);
          i2 = (OOC_INT32)w;
          i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 18621))+64);
          i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 18632))+12);
          i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 18621))+64);
          i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 18632))+12);
          i4 = OOC_ARRAY_LENGTH((_check_pointer(i4, 18637)), 0);
          OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 18586)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i2, ((OOC_CHAR16[]){99,108,97,115,115,0}), 6, (void*)(_check_pointer(i3, 18637)), i4);
...
l4:
          ...
          i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 18864)), 0);
          Strings__Append((void*)(_check_pointer(i1, 18864)), i2, (void*)(OOC_INT32)href, 2048);
          i1 = (OOC_INT32)w;
...
l32:
  ...
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 20683)))), XML_Writer__WriterDesc_WriteTextDecl)),XML_Writer__WriterDesc_WriteTextDecl)((XML_Writer__Writer)i0, "1.0", 4, "no", 3);
  ...
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 20735)))), XML_UnicodeBuffer__OutputDesc_Write8)),XML_UnicodeBuffer__OutputDesc_Write8)((XML_UnicodeBuffer__Output)i0, "<!DOCTYPE interface-description SYSTEM \047", 41);
  ...
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 20862)))), XML_UnicodeBuffer__OutputDesc_Write8)),XML_UnicodeBuffer__OutputDesc_Write8)((XML_UnicodeBuffer__Output)i0, "\047>", 3);
...
l12:
  ...
  i3 = OOC_ARRAY_LENGTH((_check_pointer(i3, 21807)), 0);
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 21721)))), XML_Writer__WriterDesc_AttrStringLatin1)),XML_Writer__WriterDesc_AttrStringLatin1)((XML_Writer__Writer)i1, ((OOC_CHAR16[]){110,97,109,101,0}), 5, (void*)(_check_pointer(i2, 21807)), i3);
  i1 = (OOC_INT32)module;
