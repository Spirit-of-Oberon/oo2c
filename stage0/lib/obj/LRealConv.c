...
OOC_INT8 LRealConv__FormatReal(const OOC_CHAR8 str__ref[], OOC_LEN str_0d) {
  ...
  i0 = Real0__FormatReal((void*)(OOC_INT32)str, str_0d, 308, "17976931348623157", 18);
  return i0;
  ;
}
...
l4_loop:
  ...
  if (i1) goto l4_loop;
l9:
  i0 = sscanf(((OOC_INT32)str+(_check_index(i0, str_0d, OOC_UINT32, 2551))), "%lf", (OOC_INT32)&value);
  i0 = i0==1;
  if (i0) goto l12;
